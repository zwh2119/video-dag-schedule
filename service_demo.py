...
registered_services = {}
for service in configs['service']:
    importlib.import_module(service['import'])
    registered_services[service['name']] = getattr(importlib.import_module(service['import']), service['call'])(service['args'])

cluster_info = configs['cluster']

resource_info = configs['resource']
